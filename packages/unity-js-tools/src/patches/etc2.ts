import { decodeEtc2Rgba8 as decodeEtc2Rgba8Orig } from '@arkntools/unity-js-tools-wasm';
import { clamp, toUint64 } from '../utils/number';
...
export const decodeEtc2Rgba8: typeof decodeEtc2Rgba8Orig = (data, width, height) => {
  const image = decodeEtc2Rgba8Orig(data, width, height);
